        ...
        <div id="content">
          <div>
            ...
            <p className="text-center wow fadeInRight animated" style={{ visibility: 'visible' }}>
              Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia <br />
              ...
              <div className="col-sm-6 wow fadeInLeft animated" style={{ visibility: 'visible' }}>
                <div className="beta-person media">
                  <img
                    ...
                    height="300"
                    className="pull-left"
                    src="https://scontent.fsgn2-3.fna.fbcdn.net/v/t1.0-9/37749370_1890435077922841_3688431438933262336_n.jpg?_nc_cat=108&_nc_oc=AQm_LeEi65OADucRRnlDmKKvZBD9V5t_h4WLtZwcfUUFrixiMSVDwdF7hvX6oTBAu_0&_nc_ht=scontent.fsgn2-3.fna&oh=a5c8b4a326a0cf56343627dc2d62bf2b&oe=5E53E5A3"
                    alt=""
                  />
                  <div className="media-body beta-person-body">
                    ...
                    <a href="single_type_gallery.html">
                      View projects <i className="fa fa-chevron-right" />
                    </a>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 wow fadeInRight animated" style={{ visibility: 'visible' }}>
                <div className="beta-person media">
                  <img
                    ...
                    height="300"
                    className="pull-left"
                    src="https://scontent.fsgn2-2.fna.fbcdn.net/v/t1.0-9/24231729_2073160012912695_6624463027151426330_n.jpg?_nc_cat=103&_nc_oc=AQnHulQS0uHuH0EvOa2DgeBtAv7H7q62BfHK68Qp69qUs7mb3tQs25HlmKn-Ee_1ZiU&_nc_ht=scontent.fsgn2-2.fna&oh=a3e393c1707487d45c93093188ec6313&oe=5E524655"
                    alt=""
                  />
                  <div className="media-body beta-person-body">
                    <h5>Hoàng Đạt</h5>
            ...
            <div className="row">
              ...
              <div className="col-sm-3">
                <div className="beta-person beta-person-full">
                  <div className="bets-img-hover">
                    <img
                      src="https://scontent.fsgn2-1.fna.fbcdn.net/v/t1.0-9/22549607_2004595326445915_6331122785871597804_n.jpg?_nc_cat=105&_nc_oc=AQllupppb72H5dyMu6sqTRpjQWGLsGl1bY6-VXmxwjaGxWLRcoURsM48uL4mFGyFMSo&_nc_ht=scontent.fsgn2-1.fna&oh=6b740e0bb17a23981ab18e60abba671d&oe=5E5298AF"
                      alt=""
                    />
                  </div>
                  <div className="beta-person-body">
                    <h5>Lê Thị Anh Đào</h5>
                    <p className="font-large">Web developer</p>
                    <p>Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia consequuntur magni dolores.</p>
                    <a href="single_type_gallery.html">
                      View projects <i className="fa fa-chevron-right" />
              ...
              <div className="col-sm-3">
                <div className="beta-person beta-person-full">
                  <div className="bets-img-hover">
                    <img
                      src="https://scontent.fsgn2-2.fna.fbcdn.net/v/t1.0-9/43878466_1902900516686517_5358888191946391552_n.jpg?_nc_cat=103&_nc_oc=AQn6Oi4yub9QGlklhftR3l1af7hcQzbZ6rDOP0GJjb_YSzbFgaEOOPzSzuhvi_uhsCU&_nc_ht=scontent.fsgn2-2.fna&oh=ddcc9c21fa868e3252c208e5068c27fe&oe=5E49F11B"
                      alt=""
                    />
                  </div>
                  <div className="beta-person-body">
                    <h5>Trịnh Tấn Duy Vương</h5>
                    <p className="font-large">Web developer</p>
                    <p>Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia consequuntur magni dolores.</p>
                    <a href="single_type_gallery.html">
                      View projects <i className="fa fa-chevron-right" />
