              ...
              <div className="container mb-5 mt-5">
                <div className="row">
                  <div className="col-sm-4">
                    <img src={products.image} height="300" width="300" alt="" />
                  </div>
                  <div className="col-sm-8">
                    <div className="single-item-body">
                      <h2 className="single-item-title">{products.name}</h2>
                    ...
                    <div className="single-item-options">
                      <h2 className="single-item-title">{products.color}</h2>
                      <div className="clearfix" />
                    </div>
                    <p>Nguyên liệu:</p>
                    <div className="single-item-options">
                      <h2 className="single-item-title">{products.material}</h2>
                      <div className="clearfix" />
                    </div>
                    <p>Xuất xứ:</p>
                    <div className="single-item-options">
                      <h2 className="single-item-title">{products.origin}</h2>
                      <div className="clearfix" />
                    </div>
                    <p>Hạn sữ dụng:</p>
                    <div className="single-item-options">
                      <h2 className="single-item-title">{products.expiry_date}</h2>
                      <div className="clearfix" />
                    </div>
                  </div>
                </div>
