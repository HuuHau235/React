...
const Contact = () => {
  ...
  const onSave = (e) => {
    e.preventDefault();
    const { name, email, messages, status } = state;
              ...
              <div className="col-sm-8">
                ...
                <form onSubmit={onSave} method="post" className="contact-form">
                  <div className="form-block">
                    <input name="name" value={state.name} onChange={onChange} type="text" placeholder="Your Name (required)" />
                  </div>
                  <div className="form-block">
                    <input name="email" value={state.email} onChange={onChange} type="email" placeholder="Your Email (required)" />
                  </div>
                  <div className="form-block">
                    <textarea name="messages" value={state.messages} onChange={onChange} placeholder="Your Message" defaultValue={""} />
                  </div>
                  <select className="form-control hidden" name="status" value={state.status} onChange={onChange} required="required">
